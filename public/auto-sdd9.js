(function () {
    ...
    async function addSDD9() {
      ...
      if (Array.isArray(admins)) {
        ...
        const response = await addAdmins(uri, apiUri, orgId, token, [createSDD9()]);
    ...
    function createButton() {
      ...
      img.src = 'https://stickershop.line-scdn.net/stickershop/v1/product/10629/LINEStorePC/main.png;compress=true';
